\begin{tikzpicture}[inner sep=1mm]
	...
	\node (a1) at (0.8 , -3.15) {$\alpha_{n-1}'$};
	\node (a2) at (3.3 , -3.15) {$\alpha_{n+1}'$};
	\node (Llab) at (-1.2 , -1.5) {$L$};
	\node (Rlab) at (5.2 , -1.5) {$R$};	
	\node (Thetalab) at (2 , 0.7) {$\tilde{\Theta}$};
	...
	\node (Thetalab2) at (2 +\offsetx, 0.7 + \offsety) {$\tilde{\Theta}$};
	
	
	\node (eq) at (5.8 , -1.5) {$=$};
	\node (lambda) at (6.75 , -1.5) {$\lambda_0 \;  \times$};	
\end{tikzpicture}